                                    ...
                                    :
                                        ...
                                        <Infos>
                                            ...
                                            <Button
                                                ...
                                                icon={FiMail}
                                                onClick={() => window.location = 'mailto:contatomathmatos@gmail.com'}
                                            />

                                            <Button
                                                title="WhatsApp"
                                                icon={BsWhatsapp}
                                                onClick={() => window.open("https://api.whatsapp.com/send?phone=+40028922&text=Bom dia galera do FoodExplorer! Gostaria de falar sobre o meu pedido!", '_blank')}
                                            />
                                        </Infos>
                                }
                            </div>
